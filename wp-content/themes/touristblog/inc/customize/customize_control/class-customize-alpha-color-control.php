...
/**
 * Class touristblog_Customize_Alpha_Color_Control
 */
class touristblog_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			'touristblog_alpha-color-picker',
