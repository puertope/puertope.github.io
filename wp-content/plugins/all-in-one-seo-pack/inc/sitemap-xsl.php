	...
	<xsl:template match="/">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<style type="text/css">body{margin:0;font-family:Helvetica,Arial,sans-serif;font-size:68.5%}#content-head{background-color:#4275f4;padding:20px 40px}#content-head h1,#content-head p,#content-head a{color:#fff;font-size:1.2em}#content-head h1{font-size:2em}table{margin:20px 40px;border:none;border-collapse:collapse}table{font-size:1em;width:75%}th{border-bottom:1px solid #ccc;text-align:left;padding:15px 5px;font-size:14px}td{padding:10px 5px;border-left:3px solid #fff}tr.stripe{background-color:#f7f7f7}table td a{display:block}table td a img{max-height:30px;margin:6px 3px}</style>
			</head>
			<body>
				<div id="content">
					<div id="content-head">
